...
from .data_loader import BenchmarkLoader, PositionLoader, StockPriceLoader
...
class Stocks(PositionLoader):
    ...
    def _get_daily_shares_owned(self):
        ...
        print('acciones por dia', daily_shares_owned)
...
class Portfolio(StockPriceLoader):
    ...
    def _get_daily_portfolio_value_usd(self):
        ...
        print('self.stocks.daily_stocks_value_usd', self.stocks.daily_stocks_value_usd)
        print('self.cash.daily_cash_balance', self.cash.daily_cash_balance)
        return pd.concat(
    ...
    def _get_running_profit(self):
        """Calculate profit"""
        print('self.cash.external_cashflows', self.cash.external_cashflows)
