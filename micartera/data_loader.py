...
class PositionLoader:
    ...
    def __init__(self, input_data_source):
    ...
    def _load_positions(self):
        ...
        """
        return self.input_data_source
        # columns=['date','action','company','yahoo_ticker','currency','num_shares','stock_price_usd','trading_costs_usd','total_usd','total_shares_held'])
        # return pd.read_csv("purchase_info.csv", parse_dates=["date"])
    ...
    def _generate_datetime_index(self):
        print('datos', self.positions["date"].min(), self.start_date, self.tickers)
...
class BenchmarkLoader(PositionLoader):
    ...
    def __init__(
        ...
        input_data_source: str = "purchase_info.csv",
    ):
        super().__init__(input_data_source)
...
class CurrencyLoader(PositionLoader):
    ...
    def __init__(self, input_data_source: str = "purchase_info.csv"):
        super().__init__(input_data_source)
